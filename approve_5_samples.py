...
print("\n" + "-" * 70)
print("⏱️ 请选择审核间隔模式:")
print("  [1] 真实质控节奏 (推荐: 3 ~ 5 分钟/样本，自然随机微调，符合 GxP 审计追踪)")
print("  [2] 快速测试模式 (约 20 ~ 30 秒/样本，用于快速检验 5 个样本审批流程)")
...
if mode_choice == "2":
    ...
    min_wait = 180
    max_wait = 300
    print("🛡️ 已选择: 真实质控节奏模式 (间隔 3 ~ 5 分钟 / 180 ~ 300 秒)")
