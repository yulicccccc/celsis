...
with open('celsis_220926_final_audit_report.json', 'r', encoding='utf-8') as f:
    report = json.load(f)
...
with open('celsis_220926_final_audit_table.md', 'w', encoding='utf-8') as f:
    f.write('\n'.join(lines_md))

with open('celsis_220926_final_audit_table.tsv', 'w', encoding='utf-8') as f:
    f.write('\n'.join(lines_tsv))

print(f'Exported {len(report)} rows to celsis_220926_final_audit_table.md and .tsv')
