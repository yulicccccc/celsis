...
with open("celsis_110926_final_audit_report.json", "r", encoding="utf-8") as f:
    report = json.load(f)
...
with open("celsis_110926_final_audit_table.tsv", "w", encoding="utf-8") as f:
    f.write("\n".join(tsv_lines))

with open("celsis_110926_final_audit_table.md", "w", encoding="utf-8") as f:
    f.write("\n".join(md_lines))

print("Generated celsis_110926_final_audit_table.tsv and celsis_110926_final_audit_table.md")
